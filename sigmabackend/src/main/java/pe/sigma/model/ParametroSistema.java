...
public class ParametroSistema {
	...
	private Integer id_parametro_sistema;
	...
	public Integer getId_parametro_sistema() {
		return id_parametro_sistema;
	}

	public void setId_parametro_sistema(Integer id_parametro_sistema) {
		this.id_parametro_sistema = id_parametro_sistema;
	}
